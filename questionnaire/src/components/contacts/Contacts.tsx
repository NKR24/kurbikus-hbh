        ...
        <div class={styles.containerMain}>
          ...
          <div class={styles.boxSecond}>
            <div class={styles.First}>
              <a
                href="https://instagram.com/hbh_barnhouse?igshid=OGQ5ZDc2ODk2ZA=="
                target="_blank"
            ...
            <div class={styles.Third}>
              <a
                href="https://youtube.com/@homebyhome?si=eAfevs0OAnCSepoz"
                target="_blank"
                rel="noopener noreferrer"
              >
          ...
          <div class={styles.boxThird}>
            <div class={styles.phone}>
              <a class={styles.number} href="tel:+79854723509">
                8 985 472 35 09
              </a>
            </div>
