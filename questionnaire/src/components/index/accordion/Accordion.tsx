        ...
        <div class={styles.boxTwo}>
          ...
          <div class={styles.second}>
            <Collapse value={isExpandedTwo()} class={styles.myTransition}>
              <p class={styles.description}>
                Да, предложим Вам свои варианты или варианты партнеров, а также
                подберем индивидуальные варианты, если ни один из наших не
                подойдет
              </p>
            </Collapse>
          </div>
          ...
          <div class={styles.second}>
            <Collapse value={isExpandedThree()} class={styles.myTransition}>
              <p class={styles.description}>
                ...
                пароизоляционная мембрана JUTAFOL, профилированный лист для
                фасадной отделки фирмы Viking, планкин из сосны с двухэтапным
                покрытием Tikkurila, энергоэффективные стеклопакеты (3 стекла, 2
                камеры) KBE Expert с ламинированным профилем 70 мм. и немецкая
                фурнитура фирмы ROTO, саморезы для скрытого монтажа фирма SPAX,
                провода внутри дома медные, негорючие маркировка NG и LS.
              </p>
            </Collapse>
          </div>
        </div>
        <div class={styles.boxFour}>
          ...
          <div class={styles.second}>
            <Collapse value={isExpandedFour()} class={styles.myTransition}>
              <p class={styles.description}>
                Да, наш специалист проведет вас от подготовки документов до
                сделки по самым подходящим для Вас условиям
              </p>
            </Collapse>
          </div>
        </div>
        <div class={styles.boxFive}>
          ...
          <div class={styles.second}>
            <Collapse value={isExpandedFive()} class={styles.myTransition}>
              <p class={styles.description}>
                Мы строим каркасные дома, используя собственное производство
                домокомплектов и фундаментов
              </p>
            </Collapse>
          </div>
        </div>
        <div class={styles.boxSix}>
          ...
          <div class={styles.second}>
            <Collapse value={isExpandedSix()} class={styles.myTransition}>
              <p class={styles.description}>
                Используются быстровозводимые и и легкие конструкции,которые
                прекрасно удерживают тепло, также для строительства каркасных
                домов нет никаких ограничений по температуре.
              </p>
            </Collapse>
          </div>
        </div>
